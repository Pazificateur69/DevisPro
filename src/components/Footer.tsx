    ...
    <footer className="bg-slate-950 text-slate-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mb-6 max-w-xs">
              Mise en relation gratuite avec des artisans qualifies pres de chez
              vous. Recevez jusqu&apos;a 3 devis en moins de 24h.
            </p>
          ...
          {/* Services */}
          <div>
            <h3 className="text-xs uppercase tracking-widest text-indigo-400 font-bold mb-6">
              Services
            </h3>
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link
                  href="/services/plomberie-urgente"
              ...
              <li>
                <Link
                  href="/services/reparation-volets-roulants"
                  className="text-slate-500 hover:text-white transition-colors"
                >
                  Volets roulants
                </Link>
              ...
              <li>
                <Link
                  href="/services/depannage-chauffage"
                  className="text-slate-500 hover:text-white transition-colors"
                >
                  Depannage chauffage
                </Link>
              ...
              <li>
                <Link
                  href="/services/recherche-fuite-eau"
                  className="text-slate-500 hover:text-white transition-colors"
                >
                  Recherche de fuite
                </Link>
              ...
              <li>
                <Link
                  href="/services/couverture-toiture"
                  className="text-slate-500 hover:text-white transition-colors"
                >
                  Couverture toiture
                </Link>
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-white/5 rounded-xl border border-white/5">
              ...
              <p className="text-sm text-slate-400">Sam : 9h - 12h</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-600">
          <p>
            &copy; {new Date().getFullYear()} Renov Habitation. Tous droits
            reserves.
          </p>
